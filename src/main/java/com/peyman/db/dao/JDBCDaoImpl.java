...
import com.peyman.db.entity.Person;
import com.peyman.db.helpers.JDBCHelper;

/**
 * SQL:
 * create table PERSON via sql file
...
public class JDBCDaoImpl
{
   ...
   {
      Person person =
              new Person( 1, "James", "Bond", "007@jamesbond.com",
                      new java.util.Date() );
      Person person2 =
              new Person( 2, "Forest", "Gump", "forestgump@jamesbond.com",
                      new java.util.Date() );
      ...
      try
      {
         ...
         System.out.println( "Persons got inserted successfully. This is \"C\" of CRUD " );
         System.out.println();
         System.out.println( "--------------------------------------------------------------------------------------" );

         // Read(get all)
         List<Person> persons = retrivePersons();
         System.out.println( "Retrieved all persons from DB.This is \"R\" of CRUD " );
