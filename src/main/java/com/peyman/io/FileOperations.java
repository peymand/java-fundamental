...
public class FileOperations {
	...
	public void moveFile() {
		File file = new File("sample.txt");
		boolean hasRename = file.renameTo(new File("D:\\dev\\java-fundamental\\src\\main\\java\\com\\peyman\\sample.txt"));
		if (hasRename) {
	...
	private void createDirectoriesAsWell() {
		File file = new File("D:/Project_Work/workspace/java-io-guide/sample.txt");
	...
	public static void main(String[] args) {
		...
		fileOperations.createDirectoriesAsWell();
